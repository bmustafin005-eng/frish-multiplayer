...
const HTML=`<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>ФРИШ Multiplayer v1.1.0 BLACK GOLD VISUAL</title><style>
...
/* v1.1.0 compact table: keep all laid terets visible without vertical scrolling */
...
/* v1.1.0 — selected BLACK PREMIUM visual */
...
}function showModal(html){const m=q('#modal');m.className='overlay';m.innerHTML='<div class="modalBox" style="position:relative"><button class="modalClose" onclick="closeModal()" aria-label="Закрыть">×</button>'+html+'</div>'}function closeModal(){const m=q('#modal');m.className='hidden';m.innerHTML=''}
</script></body></html>`;

app.get('/',(req,res)=>res.type('html').send(HTML));
server.listen(PORT,()=>console.log('FRISH v1.1.0 BLACK GOLD VISUAL on',PORT));
