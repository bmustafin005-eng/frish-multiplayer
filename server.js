...
function applyZastrel(r,offender,reason){
 ...
 r.phase='zastrel';
 notice(r,`${r.players[offender].name} — ЗАСТРЕЛ · ${reason.toUpperCase()} · +${pts}`,5000);
...
const HTML=`<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>ФРИШ Multiplayer v0.8.6 UI</title><style>
